...
.. figure:: images/help_menu.png
   ...
   #. Click on the `Run` icon (the white arrow in the green circle) and wait for the configuration completion messages in XDE console for all UART's before proceeding to the next step.
